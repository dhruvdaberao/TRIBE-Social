...
// import { API_URL } from './config'; // Import the centralized URL
...
// import axios from 'axios';
// // DEV REMINDER: Ensure a file named 'config.ts' exists in this 'api/' directory.
// // It should export the backend URL like so: `export const API_URL = 'https://your-backend-url.com';`
