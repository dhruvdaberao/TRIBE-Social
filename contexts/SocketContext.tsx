...
//     socket.on('newNotification', (notification: Notification & {sender: User}) => {
//         setNotifications(prev => [notification, ...prev]);
//         toast.info(
//             `${notification.sender.name} ${notification.type === 'follow' ? 'started following you' : notification.type === 'like' ? 'liked your post' : notification.type === 'comment' ? 'commented on your post' : 'sent you a message'}.`
//         );
//     });
